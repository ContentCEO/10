// Shared types for the Launchpad ops console.
...
// The three Launchpad pricing tiers per the Contractor Flow architecture brief.
// Foundation:        $1,997 one-time site build.
// Foundation+Growth: $997 setup + $997/mo (6-month minimum) + free CF CRM bundled.
// Revenue Share:     $497 setup + $497/mo + 8% of attributed revenue (12-month min).
export type Plan            = "foundation" | "foundation_growth" | "revenue_share";
