...
export function ProspectActions(p: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2">
      <button
        onClick={() => call("/api/launchpad/scan", { prospectId: p.prospectId }, "scan")}
        disabled={!!busy}
      ...
      <button
        onClick={() => call("/api/launchpad/generate", { prospectId: p.prospectId }, "gen")}
      ...
      <button
        onClick={() => call("/api/launchpad/outreach", { prospectId: p.prospectId, channel: "email" }, "email")}
      ...
      <button
        onClick={() => call("/api/launchpad/outreach", { prospectId: p.prospectId, channel: "sms" }, "sms")}
      ...
      <button
        onClick={() => call("/api/launchpad/pipeline", { prospectId: p.prospectId, channel: "email" }, "all")}
        disabled={!!busy || p.dnc}
