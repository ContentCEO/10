...
export async function StuckLeadAlert() {
  ...
  return (
    <div className="rounded-2xl bg-amber-500/[0.08] ring-1 ring-amber-400/30 px-5 py-3 flex items-center gap-3">
      ...
      <Link href="/leads?stale=14" className="inline-flex items-center text-xs font-semibold px-3 py-1.5 rounded-md bg-amber-500/20 text-amber-200 ring-1 ring-amber-400/30 hover:bg-amber-500/30 shrink-0">
        Review stale →
      </Link>
    </div>
  );
