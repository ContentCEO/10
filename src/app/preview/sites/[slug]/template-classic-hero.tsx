...
function PreviewBanner({ slug }: { slug: string }) {
  // Contractor Flow logo + "Launchpad" sub-brand badge (rust orange per
  // brief Section 3). This bar appears on every preview so visitors see the
  // umbrella brand + which sub-brand built the site.
  return (
    <div className="bg-stone-900 text-white text-sm">
      <div className="mx-auto max-w-6xl px-5 py-2.5 flex items-center justify-between gap-3 flex-wrap">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            <div className="h-7 w-7 rounded-md bg-white text-stone-900 flex items-center justify-center font-black text-sm">CF</div>
            <span className="font-semibold tracking-tight">Contractor Flow</span>
          </div>
          <span
          ...
          <span className="text-stone-400 hidden sm:inline">— this site was built for you automatically</span>
        </div>
        <Link
          href={`/preview/sites/${slug}/claim`}
          className="rounded-md text-white px-3 py-1.5 text-xs font-semibold hover:opacity-90"
          style={{ backgroundColor: "#C44A26" }}
        >
          Claim this site →
        </Link>
      ...
      <div className="mx-auto max-w-6xl px-5 grid sm:grid-cols-3 gap-8">
        ...
        <div className="text-sm text-slate-500">
          ...
          <div className="mt-2 flex items-center gap-2">
            ...
            <span className="font-semibold text-slate-200">Contractor Flow</span>
            <span
              className="text-[9px] uppercase tracking-wider px-1.5 py-0.5 rounded-full font-bold text-white"
              style={{ backgroundColor: "#C44A26" }}
            >
              Launchpad
            </span>
