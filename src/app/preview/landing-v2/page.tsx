 ...
 * /preview/landing-v2
 *
 * Sandbox preview of the upgraded landing. Not wired to / yet.
 * Shows the desktop-first direction: hero is a hero macOS-style
 * window mockup, download is the primary action, reviews replace
 * abstract trust signals, every section breathes with motion.
 *
 * Approve and we replace / with this. Reject and we delete one file.
 */
    ...
    <main className="relative min-h-screen overflow-hidden bg-ink-950 text-white">
      ...
      <header className="sticky top-0 z-40 backdrop-blur-xl bg-ink-950/40 border-b border-white/5">
        <div className="mx-auto max-w-6xl px-6 py-3.5 flex items-center justify-between">
          <Link href="/preview/landing-v2" className="flex items-center gap-2.5 font-semibold tracking-tight">
