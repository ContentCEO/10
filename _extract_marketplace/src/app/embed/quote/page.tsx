...
//   <iframe src="https://yourapp.com/embed/quote?partner=<token>"
//           style="border:0;width:100%;height:820px"></iframe>
//
// When ?partner= is present, every submission credits that partner's wallet.
...
export default function EmbedQuotePage({
  ...
  const partnerToken = typeof searchParams.partner === "string" ? searchParams.partner : null;
  return (
    <div className="bg-white min-h-screen">
      <main className="p-4 max-w-xl mx-auto">
        ...
        <EmbedClient partnerToken={partnerToken} />
